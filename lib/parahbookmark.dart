...
class _ParahDetailState extends State<ParahDetail> {
  ...
  Future<void> addBookmark(int index) async {
    ...
    Map<String, dynamic> bookmark = {
      'surah': juzVerses[index]['surah'],
      'verse': juzVerses[index]['verse'],
      'text': juzVerses[index]['text'],
    };

    savedBookmarks.add(jsonEncode(bookmark));
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(
          ...
          style: const TextStyle(fontFamily: 'mushaf', color: Colors.white),
        ),
        centerTitle: true,
                ...
                return Card(
                  child: ListTile(
                    title: Text(
                      ...
                      style: const TextStyle(fontFamily: 'mushaf', fontSize: 20),
                    ),
                    subtitle: Text(
                    ...
                    trailing: IconButton(
                      icon: const Icon(Icons.bookmark_add, color: Colors.brown),
